...
public class ModelDef
{
    ...
    public int atlasMaxDim = 1024;      // BAKE-TIME: longest side of the baked atlas in px (256/512/1024/2048). Smaller = smaller shipped _Atlas.asset (DXT1). Units are ~80px at map zoom so 512-1024 is ample. 0/absent -> 1024 (baker guards it), so old registries are safe.
