...
public class ModelDef
{
    ...
    public bool hideSubPawns = false;   // RUNTIME (not baked): strip the donor definition's SubPawnDefinitions at injection — secondary attachment pawns like a helicopter gunship's independent rotor (the "GPU rotor" no mesh swap can remove). Leave OFF for units that deliberately BORROW the donor rotor (static helicopter bakes).
